...
- Grep for function → read only those lines → add try-catch → offer logging/retry if needed
- Avoid: reading entire files speculatively, comprehensive error taxonomy, full frameworks
